...
def create_builder(test_subject_id=None, config_file='experiment_1_baseline.json', tutorial=False):
    world_size = [24, 28]
    bg_color = "#ebebeb"
    wall_color = "#adadad"
    tdp = "baseline"
    ...
    config_path = os.path.join(os.path.realpath("mhc"), 'cases', config_file)
